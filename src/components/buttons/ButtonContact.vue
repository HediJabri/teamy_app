<template>
  <div
    class="btn-contact-wrapper"
    :class="{'highlighted': contactHighlighted}"
  >
    <div
      class="btn-contact el-button--default el-button"
      @click="openDialogContact()"
    >
      <span
        class="emoji"
        v-if="contactHighlighted"
      >👇</span>
      <span>Contact </span>
      <i
    ...
    <dialog-contact
      ...
      @closeDialog="dialogContact = false"
    />
  </div>
</template>
<script>
