...
import CardSeasonsList from '@/components/cards/seasons/CardSeasonsList'

export default {
  name: 'SeasonsIndex',
  mixins: [guards, utilities],
  components: { CardTeam, CardSeasonsList },
  computed: {
    ...mapGetters(['currentUser', 'currentTeam'])
  },
  created() {
    this.requireTeamAdmin(this.currentUser, this.currentTeam)
  }
}
</script>
